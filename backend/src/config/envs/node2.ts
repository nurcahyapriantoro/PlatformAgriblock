...
export function createNode2Config() {
  return defineConfig({
    NODE_ENV: "development",
    APP_PORT: 3002,
    API_PORT: 5002,
    PRIVATE_KEY:
      "2458c7ba38164bdfa51f120ae9b680cbf456963315931fb78a0632f217bdc668",
    // PUBLIC_KEY: "0401f67cf6a8787ec26ec561cfc3208388b94b934fb74caecca25caeb12c5c99babdf5604fb703ddd7aca4bbc90a3ee8eb6c86183707d2cee9fa93c500bc1323bd",
    GENESIS_PRIVATE_KEY:
      "ad5a70855d86761e227f5100512e55e064e7b284ab89aad1c04347e5c520a2a4",
    MY_ADDRESS: "ws://localhost:3002",
    PEERS: [
      {
        publicKey:
